...
At the moment, there are implementations of the &pi; friamework in [Maude](http://maude.cs.uiuc.edu) and Python, both deloped by Christiano Braga (<http://www.ic.uff.br/~cbraga>).
