...
#              &                                                                                                                                                                                                                                                                                             &               &  \pi & \\
# 	     &                                                                                                                                                                                                                                                                                             &               &  Automata & \\ \\
# 	     &                                                                           {\scriptsize Chomsky's \ hierarchy}                                                                                                                                                                                                                  &               &  \xrightarrow{interpreter} & output \\     
# source  & {\xrightarrow{lexer} \circ \xrightarrow{parser}  \circ \xrightarrow{\begin{array}{c} AST \\ transformer\end{array}} \circ \xrightarrow{\begin{array}{c}type \\ checker\end{array}} \circ \xrightarrow{\begin{array}{c}code \\ generator \end{array}}} & \pi \ lib & \xrightarrow{\begin{array}{c} code \\ generator \end{array}} & machine \ code \\
# code             &                                                                                                                                                                                                                                                                                            &                 & \xrightarrow{model \ checker(P)} & counter\mbox{-}examples  \\
#             &                                                                                                                                                                                                                                                                                             &                 & {\scriptsize where \ P \ is \ a \ property}        &    \\
#             &                                                                                                                                                                                                                                                                                             &                 & {\scriptsize \ in \ a \ suitable \ logic.}        &   \\           
# \end{array}$
