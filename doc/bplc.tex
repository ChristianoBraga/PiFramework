...
\nwenddocs{}\nwbegincode{3}\moddef{bplc-sem-comp}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
fmod VALUE-SORT is
    sort Value . 
endfm
...
\nwenddocs{}\nwbegincode{5}\moddef{bplc-exp}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
fmod EXP is
    pr RAT .
    ex GSMC .  ex ENV .
...
\nwenddocs{}\nwbegincode{7}\moddef{bplc-cmd}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
mod CMD is
    ex EXP .
...
\nwenddocs{}\nwbegincode{9}\moddef{bplc-dec}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
mod DEC is
    ex CMD .
...
\nwenddocs{}\nwbegincode{11}\moddef{bplc-out}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
mod OUT is
    ex DEC .
...
\nwenddocs{}\nwbegincode{13}\moddef{bplc-ext}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
mod EXIT is
    ex OUT .
...
\nwenddocs{}\nwbegincode{15}\moddef{bplc}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{17}\moddef{bplc-mc}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
load lmc
